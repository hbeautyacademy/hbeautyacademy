                ...
                <div className='detail-page__con'>
                    ...
                    <div className='service__con fade-in-self'>
                        ...
                        <div className='service__txt'>
                            위더스는 전문적인 사업 컨설팅을 제공합니다. 실제로 저희는 다양한 업종의 창업과 운영을 도와드렸는데요. 이러한 경험을 바탕으로 해당 업종에 가장 적절한 사업 계획을 기획해드리고 상담을 해드리고 있습니다.
                            <br/><br/>
                            저희는 컨설팅에 있어서 가장 중요한 것은 통계라고 생각합니다. 아무리 추측을 통해 다양한 계획을 세운다 하더라도 현실과는 거리가 있기 때문이죠. 위더스는 다양한 빅데이터를 기반으로 컨설팅을 도와드립니다.
                            <br/><br/>
                            위더스는 어떤 업종을 어느 지역에서 시작할 때 사업이 극대화될 수 있을지 자세하게 분석합니다. 실제로 저희의 컨설팅을 받아서 사업을 시작한 분들 중에는 어느새 지점을 늘려나가며 고공성장하고 계신 대표님들도 계시죠.
                            <br/><br/>
