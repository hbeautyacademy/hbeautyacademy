                ...
                <div className='detail-page__con'>
                    ...
                    <div className='service__con fade-in-self'>
                        ...
                        <div className='service__txt'>
                            ...
                            <br/><br/>
                            위더스는 최고의 마케팅이란 소비자가 자신의 지인을 소개할만큼 브랜드를 신뢰하는 것이라고 생각합니다. 하지만 이렇게 되기까지는 초기의 고객을 확보해야겠죠. 아무리 좋은 상품을 개발해서 판매하더라도 브랜드의 존재를 아무도 모른다면 단골 고객을 확보할 수 없기 때문이니까요.
                            <br/><br/>
                            위더스는 사업 초기에 고객확보에 필요한 모든 부분들을 도와드립니다. 블로그, 인스타그램, 플레이스 등의 각종 SNS에서부터 실제 고객이 접근하게 하기위한 이벤트 기획까지. 브랜드를 알리기 위한 모든 방면의 일을 기획합니다.
                            <br/><br/>
